(() => {
  ...
  ***************************************************************************** */
  ...
  function mkHandle(url) {
    ...
    const messages = new Repeater(async (push2, stop2) => {
      return new Promise((resolve) => {
        ...
        webSocket.addEventListener("message", (event) => push2({type: "message", event}));
      });
    });
      ...
      return await (async () => {
        while (true) {
          ...
          if (nxt.done) {
            ...
            morphdom_esm_default(root, currArray.join(""));
          }
        }
      })();
    } finally {
  ...
  // src/index.ts
  console.log(attach(document.body, "ws://localhost:5000"));
})();
